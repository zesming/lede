define KernelPackage/acpi-mdio
  ...
  DEPENDS:=@TARGET_armsr||TARGET_armvirt_64 +kmod-libphy +kmod-mdio-devres
...
define KernelPackage/bcmgenet
  SUBMENU=$(NETWORK_DEVICES_MENU)
  DEPENDS:=@TARGET_armsr||TARGET_armvirt_64 +kmod-mdio-bcm-unimac
...
define KernelPackage/mdio-bcm-unimac
  SUBMENU=$(NETWORK_DEVICES_MENU)
  DEPENDS:=@TARGET_armsr||TARGET_armvirt_64 +kmod-of-mdio
...
define KernelPackage/fsl-pcs-lynx
  SUBMENU=$(NETWORK_DEVICES_MENU)
  DEPENDS:=@TARGET_armsr||TARGET_armvirt_64 +kmod-libphy +kmod-of-mdio +kmod-phylink
...
define KernelPackage/fsl-fec
  SUBMENU:=$(NETWORK_DEVICES_MENU)
  DEPENDS:=@TARGET_armsr||TARGET_armvirt_64 +kmod-libphy +kmod-of-mdio \
...
define KernelPackage/fsl-xgmac-mdio
  SUBMENU=$(NETWORK_DEVICES_MENU)
  DEPENDS:=@TARGET_armsr||TARGET_armvirt_64 +kmod-libphy +kmod-of-mdio +kmod-acpi-mdio
...
define KernelPackage/fsl-enetc-net
  ...
  DEPENDS:=@TARGET_armsr||TARGET_armvirt_64 +kmod-phylink +kmod-fsl-pcs-lynx
  KCONFIG:= \
    CONFIG_FSL_ENETC \
    CONFIG_FSL_ENETC_VF \
...
define KernelPackage/fsl-dpaa1-net
  ...
  DEPENDS:=@TARGET_armsr||TARGET_armvirt_64 +kmod-fsl-xgmac-mdio +kmod-libphy +kmod-crypto-crc32
  KCONFIG:= \
    CONFIG_FSL_DPAA=y \
    CONFIG_FSL_DPAA_ETH \
    CONFIG_FSL_FMAN \
...
define KernelPackage/fsl-dpaa2-net
  ...
  DEPENDS:=@TARGET_armsr||TARGET_armvirt_64 +kmod-fsl-xgmac-mdio +kmod-phylink \
...
define KernelPackage/fsl-dpaa2-console
  ...
  DEPENDS:=@TARGET_armsr||TARGET_armvirt_64
...
define KernelPackage/mvneta
  ...
  DEPENDS:=@TARGET_armsr||TARGET_armvirt_64 +kmod-marvell-mdio +kmod-phylink
...
define KernelPackage/thunderx-net
  ...
  DEPENDS:=@TARGET_armsr||TARGET_armvirt_64_armv8 +kmod-phylink +kmod-mdio-thunder
...
define KernelPackage/octeontx2-net
  ...
  DEPENDS:=@TARGET_armsr||TARGET_armvirt_64 +kmod-phylink +kmod-of-mdio +kmod-macsec \
    +kmod-ptp
...
define KernelPackage/renesas-net-avb
  ...
  DEPENDS:=@TARGET_armsr||TARGET_armvirt_64 +kmod-phylink +kmod-mii +kmod-ptp +kmod-libphy +kmod-mdio-gpio
  KCONFIG:=CONFIG_RAVB
